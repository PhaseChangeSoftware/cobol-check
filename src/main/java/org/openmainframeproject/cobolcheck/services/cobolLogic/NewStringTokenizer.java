 ...
 * @since   1.0
 */
public class NewStringTokenizer implements Enumeration<Object> {
   ...
   */
  public NewStringTokenizer(String str, String delim, boolean returnDelims) {
    currentPosition = 0;
    newPosition = -1;
    delimsChanged = false;
    this.str = str;
   ...
   * @throws    NullPointerException if str is {@code null}
   */
  public NewStringTokenizer(String str) {
    this(str, " \t\n\r\f", false);
  }
